(function () {
  ...
  */
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/, 'Cassius Sanches Gachido de Souza'),
  );
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'amparense'));
  ...
  */
  ...
  console.log(
    text.replace(/O Centauro de Luvas/, function (phrase) {
  ...
  */
  ...
  console.log(
    'O mês de março é representado pelo número ' +
