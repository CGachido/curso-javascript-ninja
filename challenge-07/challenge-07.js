...
*/
const myArray = ["oi", 1, null, [1, 2, 3], { name: "oi", sobrenome: "tchau " }];
/*
...
*/
var element = myArray[5][1];

console.log(`O segundo elemento do segundo array é ${element}`);
/*
