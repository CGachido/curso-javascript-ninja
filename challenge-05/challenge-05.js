...
array criado.
*/
console.log(myOtherFunction(myArray, 0));
console.log(myOtherFunction(myArray, 1));
console.log(myOtherFunction(myArray, 2));
console.log(myOtherFunction(myArray, 3));
console.log(myOtherFunction(myArray, 4));
